...
library(fastDummies)
#WINHOME
setwd("C:/Users/stud1/OneDrive - Universita' degli Studi di Roma Tor Vergata/RA/TILDA")
...
#load("C:/Users/stud1/OneDrive - Universita' degli Studi di Roma Tor Vergata/RA/HRS/MEMHRS_definitive.RData")
#MAC
#setwd("/Users/stud1monti/Library/CloudStorage/OneDrive-Universita'degliStudidiRomaTorVergata/RA/HRS")
#load("/Users/stud1monti/Library/CloudStorage/OneDrive-Universita'degliStudidiRomaTorVergata/RA/HRS/MEMHRS_definitive.RData")
#-------FORMATTING CPI DATA-------
tildadata <- read_dta("output/H_TILDA.dta")
...
hrs_w7 <- hrsdata %>%
  select(hhidpn, r7cancre, r7diabe, r7hearte, r7hibpe, r7lunge, r7stroke, r7bmi,
         ...
         r7shopa, r7mealsa, r7medsa, r7moneya, r7ipena, h7itot, ragender, h7hhres, ragender
  ) %>%
  filter(r7agey_e >= 50)
...
# write.csv(hrs_w7, "C:/Users/stud1/OneDrive - Universita' degli Studi di Roma Tor Vergata/RA/HRS/hrs_w7.csv")
write_dta(hrs_w7, "C:/Users/stud1/OneDrive - Universita' degli Studi di Roma Tor Vergata/RA/HRS/output/hrs_w7.dta")
# write.csv(hrs_w12, "C:/Users/stud1/OneDrive - Universita' degli Studi di Roma Tor Vergata/RA/HRS/hrs_w12.csv")
