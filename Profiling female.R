...
share_w1 <- read_dta(paste0(base_path, "SHARE/output/cluster_assignments/gender/share_w1f.dta"))
share_w6 <- read_dta(paste0(base_path, "SHARE/output/cluster_assignments/gender/share_w6f.dta"))
hrs_w7 <- read_dta(paste0(base_path, "HRS/output/cluster_assignments/gender/hrs_w7f.dta"))
hrs_w12 <- read_dta(paste0(base_path, "HRS/output/cluster_assignments/gender/hrs_w12f.dta"))
elsa_w2 <- read_dta(paste0(base_path, "ELSA/UKDA-5050-stata/output/cluster_assignments/gender/elsa_w2f.dta"))
elsa_w8 <- read_dta(paste0(base_path, "ELSA/UKDA-5050-stata/output/cluster_assignments/gender/elsa_w8f.dta"))
mhas_w2 <- read_dta(paste0(base_path, "MHAS/output/cluster_assignments/gender/mhas_w2f.dta"))
mhas_w4 <- read_dta(paste0(base_path, "MHAS/output/cluster_assignments/gender/mhas_w4f.dta"))
klosa_w3 <- read_dta(paste0(base_path, "KLoSA/output/cluster_assignments/gender/klosa_w3f.dta"))
klosa_w8 <- read_dta(paste0(base_path, "KLoSA/output/cluster_assignments/gender/klosa_w8f.dta"))
charls_w1 <- read_dta(paste0(base_path, "CHARLS/output/cluster_assignments/gender/charls_w1f.dta"))
charls_w4 <- read_dta(paste0(base_path, "CHARLS/output/cluster_assignments/gender/charls_w4f.dta"))

# Set working directory
setwd(paste0(base_path, "Clustering/Analysis/female"))
jco_colors <- c("#2c7bb6", "#519fcb", "#81b5d3", "#c1cfb9", "#f6d1a5", "#f09068", "#f46d43", "#d73027")
#-------------------Health status-------------------
# Set output directory
output_path <- file.path(base_path, "Clustering/Analysis/female/Health status/")
...
ggsave("/Users/pietromonti/Library/CloudStorage/OneDrive-Universita'degliStudidiRomaTorVergata/RA/Clustering/Analysis/female/Increase_in_Joint_Prevalence.pdf",
       width = 10, height = 8)
#-------
...
ggplot(long_data, aes(x = Pair, y = value, fill = variable)) +
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave("/Users/pietromonti/Library/CloudStorage/OneDrive-Universita'degliStudidiRomaTorVergata/RA/Clustering/Analysis/female/Contribution_of_Morbidities.pdf",
       width = 10, height = 8)
